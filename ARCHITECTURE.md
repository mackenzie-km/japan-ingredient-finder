...
- **Scraping-adjacent but not scraping in the sense that matters.** HTML-parsing 3 sources is intentional and was a deliberate risk call, not an oversight: non-commercial, low-volume, cached use of public unauthenticated pages carries low legal risk (*hiQ Labs v. LinkedIn*, 9th Cir. 2019/2022 — accessing public, non-logged-in pages generally isn't a CFAA violation).
