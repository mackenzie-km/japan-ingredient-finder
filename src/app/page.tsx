  ...
  return (
    <div className="flex flex-col flex-1 items-center font-sans">
      <main className="flex flex-1 w-full max-w-5xl flex-col items-center gap-6 py-10 px-6">
        ...
        <div className="w-full rounded-[24px] bg-white border border-[#e5e5e5] shadow-[0_20px_40px_rgba(0,0,0,0.06)] px-6 pt-8 pb-4 sm:px-10 flex flex-col items-center gap-4">
          <div className="text-center flex flex-col items-center">
            ...
            <div className="mt-2 h-1 w-[60%] max-w-[8rem] rounded-full bg-gradient-to-r from-[#d68c45] to-[#f1caa1] mb-1" />
